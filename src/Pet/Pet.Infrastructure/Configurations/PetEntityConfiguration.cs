...
using Pet.Domain.ValueObjects;

namespace Pet.Infrastructure.Configurations;
    ...
    where TPet : Domain.Entities.Pet
{
    public void Configure(EntityTypeBuilder<TPet> builder)
    {
        ...
        builder.Property(p => p.EstimatedAge)
            .HasComputedColumnSql("DATEDIFF(day, DateOfBirth, GETUTCDATE()) / 365")
            .HasColumnType("int");
